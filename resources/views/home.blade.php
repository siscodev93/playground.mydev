...
<header class='bg-slate-400 w-full h-full flex items-center bg-hero-bg bg-cover bg-center'>
    ...
    <div class="container mx-4 p-8 lg:w-1/2">
        ...
        <div class="flex flex-row my-6 space-x-4">
            <a href="#" class='border-slate-800 border rounded-lg px-6 py-2 transition duration-300 hover:bg-slate-800 hover:text-white'>Get Started</a>
            <a href="#" class='border-slate-800 bg-slate-800 text-white border rounded-lg px-6 py-2 transition duration-300 hover:bg-white hover:text-slate-800'>Learn More</a>
        </div>
    </div>
</header>
